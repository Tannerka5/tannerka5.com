...
const BlogGrid: FC<BlogGridProps> = ({ posts }) => {
  ...
  return (
    <main className="bg-cream dark:bg-dark-bg min-h-screen transition-colors duration-300">
      {/* Hero Section */}
      <section className="relative py-20 px-4 bg-gradient-to-br from-primary/5 via-accent/5 to-secondary/5 dark:from-primary/10 dark:via-accent/10 dark:to-secondary/10">
        <div className="max-w-7xl mx-auto text-center">
          <motion.h1
            ...
            className="text-5xl md:text-6xl font-display font-bold text-earth dark:text-dark-text mb-6"
          >
            Blog & Articles
          </motion.h1>
          <motion.p
            ...
            className="text-xl text-earth/70 dark:text-dark-text-secondary max-w-3xl mx-auto"
          >
      ...
      <section className="py-20 px-4">
        <div className="max-w-7xl mx-auto">
          {posts.length === 0 ? (
            ...
            >
              <p className="text-xl text-earth/70 dark:text-dark-text-secondary">
